...
//! section 8 example must verify against its companion schema.
...
fn spec_code_blocks_parse() {
    for file in [
        "README.md",
        "spec/1.0.0/02-guide.md",
        "spec/1.0.0/03-lexical.md",
        "spec/1.0.0/04-tokens.md",
        "spec/1.0.0/05-grammar.md",
        "spec/1.0.0/06-values.md",
        "spec/1.0.0/07-errors.md",
        "spec/1.0.0/08-example.md",
    ] {
